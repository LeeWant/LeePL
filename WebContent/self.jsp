...
<div class="container">
	...
	<div class="col-md-1 column"></div>
		...
		<div class="col-md-3 column">
			<form role="form" method="post" action="self">
				
				<label for="exampleInputEmail1">修改密码</label>
				<div class="form-group">
					 <label for="exampleInputPassword1">输入原始密码</label><input type="password" name="oldUserPass" id="password_old" class="form-control" />
					  <label for="exampleInputPassword1">输入新密码</label><input type="password" name="userPass1" id="password" class="form-control" />
					  <label for="exampleInputPassword1">确认新密码</label><input type="password" name="userPass2" id="password_check" class="form-control" />
				</div>
				<div class="form-group">
			...
			<hr>
			<form role="form" method="post" enctype="multipart/form-data" action="fileImage">
			<div class="form-group">
					 <label for="exampleInputFile">修改头像</label><input name="image" type="file" />
					<p class="help-block">
						请选择头像文件
					</p>
				</div>
