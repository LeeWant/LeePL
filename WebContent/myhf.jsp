		...
		<div class="col-md-7 column">
			<table class="table table-bordered">
			  ...
			  <c:forEach items="${hflist}" var="hfMap">
			    <tr>
			      <td><a href="this?zt_id=${hfMap.zt_id}">${hfMap.zt_title}</a></td>
			      <td>${hfMap.hf_content}</td>
			      <td>${hfMap.hf_time}</td>
			      <td><a href="deletehf?hf_id=${hfMap.hf_id}&zt_id=${hfMap.zt_id}">删除</a>
			    </tr>
			  </c:forEach>
			  </tbody>
			</table>
