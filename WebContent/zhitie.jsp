...
<title>植帖</title>
	...
	<link href="css/zhitie.css" rel="stylesheet">
<%
	String dp1,dp2;
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="active"><a href="zhitie">植帖</a></li>
                <li class="dropdown">
	...
	<div class="row clearfix">
		...
		<div class="col-md-8 column">
			<ul class="list-unstyled">
				<!-- 循环显示数据库开始 -->
    			<c:forEach items="${rslist}" var="zhitieMap">
					<li>
						<div class="content">
							<div class="author">
								<div class="name">
								<a><img class="img-circle" src=${zhitieMap.user_img}></a>
								<a target="_blank" href="zhitie?user_id=${zhitieMap.user_id}">${zhitieMap.user_id}</a><span class="time"><span>&nbsp;&nbsp;&nbsp;发布于：${zhitieMap.zt_time}</span>
								</div>
							</div>
							<a target="_blank" href="this?zt_id=${zhitieMap.zt_id}"><h2>${zhitieMap.zt_title}</h2></a>
							<p>${zhitieMap.zt_content}</p>
							<div>
								
								<a target="_blank" style="float:right;" href="this?zt_id=${zhitieMap.zt_id}">${zhitieMap.zt_hfl}评论</a>
							</div>
						</div>
						<hr />
					</li>
